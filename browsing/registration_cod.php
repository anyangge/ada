...
//         $codeExists = get_cod_subscribed(); 
	        ...
	        */
	        ...
	        $string_to_search = '#(' . $REG_code .') (\d{1,4}) (client\d)#';
...
//      	      $livello = 1;
    	        $result2 = Multiport::course_instance_presubscribe_to_tester($instance_id_found,$id_user,$livello,$client_found,$code_found);
	            //$result2 = $dh->course_instance_student_presubscribe_add($instance_id_found,$id_user);
	             if (AMA_DataHandler::isError($result2)){
	                    ...
	                    $result3 = Multiport::course_instance_subscribe_to_tester($instance_id_found,$id_user,$livello,$client_found);
	        ...
	        $text = sprintf(translateFN('Gentile %s, ti chiediamo di confermare la tua registrazione in %s.'),
	                $userObj->getFullName(), PORTAL_NAME)
	              . PHP_EOL . PHP_EOL
	              . translateFN('Lo username che ti è stato assegnato è il seguente:')
	              . ' ' . $userObj->getUserName()
	              . PHP_EOL . PHP_EOL
	              . sprintf(translateFN('Puoi confermare la tua registrazione a %s seguendo questo link:'), PORTAL_NAME)
	              . PHP_EOL
