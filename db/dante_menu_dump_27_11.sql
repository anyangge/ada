...
--
-- Host: localhost
-- Generation Time: Nov 27, 2014 alle 11:09
...
(26, 'video conference', NULL, 'facetime video', NULL, '{"target":"_blank"}', '%HTTP_ROOT_DIR%/comunica', 'videochat.php', NULL, NULL, 0, 0, 20, '%NEVER%'),
...
(112, 'newsletter', NULL, 'mail outline', '', NULL, '%MODULES_NEWSLETTER_HTTP%', NULL, NULL, NULL, 0, 0, 15, '%NEVER%'),
...
(138, 'glossario', NULL, 'book', NULL, NULL, '%HTTP_ROOT_DIR%/browsing', 'main_index.php', 'op=glossary', NULL, 0, 0, 0, '%ALWAYS%'),
(139, 'codici iscrizione studenti', NULL, 'code', NULL, NULL, '%HTTP_ROOT_DIR%', 'modules/code_man', NULL, NULL, 0, 0, 30, '%MODULES_CODEMAN%');
...
(158, 'modules/code_man', 'index.php', 6, 0, 0, 124);
...
--
ALTER TABLE `menu_page`
MODIFY `tree_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'id of the menu tree for the given module, script, user_type and self instruction',AUTO_INCREMENT=159;
/*!40101 SET CHARACTER_SET_CLIENT=@OLD_CHARACTER_SET_CLIENT */;
/*!40101 SET CHARACTER_SET_RESULTS=@OLD_CHARACTER_SET_RESULTS */;
/*!40101 SET COLLATION_CONNECTION=@OLD_COLLATION_CONNECTION */;
...
--
-- Host: localhost
-- Generation Time: Nov 27, 2014 alle 11:10
-- Versione del server: 5.5.38-cll-lve
-- PHP Version: 5.4.29
